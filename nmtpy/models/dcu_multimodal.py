...
class Model(Attention):
    ...
    def build(self):
        ...
        emb  = dropout(self.tparams['Wemb_enc'][x.flatten()], self._trng, self.emb_dropout, self._use_dropout)
        ...
        embr = dropout(self.tparams['Wemb_enc'][xr.flatten()], self._trng, self.emb_dropout, self._use_dropout)
        ...
        # Dropout
        logit = dropout(tanh(logit_gru + logit_emb + logit_ctx_text + logit_ctx_img), self._trng, self.out_dropout, self._use_dropout)
