...
class Model(Attention):
    ...
    def build(self):
        ...
        emb  = dropout(self.tparams[self.src_emb_name][x.flatten()], self._trng, self.emb_dropout, self._use_dropout)
        ...
        embr = dropout(self.tparams[self.src_emb_name][xr.flatten()], self._trng, self.emb_dropout, self._use_dropout)
        ...
        # Apply dropout
        text_ctx = dropout(text_ctx, self._trng, self.ctx_dropout, self._use_dropout)
        ...
        emb_trg = self.tparams[self.trg_emb_name][y.flatten()]
        ...
        # Dropout
        logit = dropout(tanh(logit_gru + emb_trg + logit_ctx), self._trng, self.out_dropout, self._use_dropout)
