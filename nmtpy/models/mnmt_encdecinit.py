...
class Model(Attention):
    ...
    def build(self):
        ...
        proj = get_new_layer(self.enc_type)[1](self.tparams, emb, prefix='encoder',
                                               init_states=init_state, mask=x_mask, layernorm=self.lnorm)
        ...
        projr = get_new_layer(self.enc_type)[1](self.tparams, embr, prefix='encoder_r',
                                                init_states=init_state, mask=xr_mask, layernorm=self.lnorm)
    ...
    def build_sampler(self, **kwargs):
        ...
        # encoder
        proj  = get_new_layer(self.enc_type)[1](self.tparams, emb, prefix='encoder', layernorm=self.lnorm, init_states=init_state)
        projr = get_new_layer(self.enc_type)[1](self.tparams, embr, prefix='encoder_r', layernorm=self.lnorm, init_states=init_state)
